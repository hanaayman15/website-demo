...
function ClientNutritionProfile() {
  const { bodyHtml, inlineScripts, loading, error } = useLegacyPage('/legacy/client-nutrition-profile.html');

  useEffect(() => {
    // Migration metadata for this page.
    const migrationInfo = {
      file: 'client-nutrition-profile.html',
      inlineScriptCount: 1,
      formCount: 1,
    };
  ...
  return (
    <LegacyHtmlRenderer
      pageName="ClientNutritionProfile"
      loading={loading}
      error={error}
      bodyHtml={bodyHtml}
    />
